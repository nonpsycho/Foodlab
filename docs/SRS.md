...
### 1.1 Назначение
Документ описывает требования к веб-приложению **FoodLab** - платформе для управления рецептами, ингредиентами и кулинарными коллекциями. Система предоставляет REST API и React-интерфейс для работы с рецептами.
