...
> ---
>
> ### Тест 005-2: Поиск по ингредиенту  
> **Действие:** Указать ингредиент  
> **Ожидаемый результат:** Отображаются рецепты с этим ингредиентом  
> **Фактический результат:** Соответствует  
> **Статус:** ✅ Пройден  
>
> ---
>
> ### Тест 005-3: Фильтр по диете  
> **Действие:** Выбрать тип диеты (например, веган)  
> **Ожидаемый результат:** Отображаются подходящие рецепты  
> **Фактический результат:** Работает корректно  
> **Статус:** ✅ Пройден  
>
> ---
>
> ### Тест 005-4: Сброс фильтров  
> **Действие:** Нажать «Сбросить»  
> **Ожидаемый результат:** Показаны все рецепты  
> **Фактический результат:** Всё корректно  
> **Статус:** ✅ Пройден  
...
> ---
>
> ### Тест 007-3: Удаление пользователя  
> **Ожидаемый результат:** Пользователь удалён, данные очищены  
> **Факт:** Работает корректно  
> **Статус:** ✅ Пройден  
...
> ---
>
> ### Тест 008-2: Проверка на iPhone 14 Pro Max  
> **Ожидаемый результат:** UI адаптирован, элементы кликабельны  
> **Факт:** Всё корректно  
> **Статус:** ✅ Пройден  
>
> ---
>
> ### Тест 008-3: Проверка на Android (Pixel 7)  
